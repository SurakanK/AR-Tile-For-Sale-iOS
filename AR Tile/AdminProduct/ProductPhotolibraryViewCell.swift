//
//  ProductPhotolibraryViewCell.swift
//  AR Tile
//
...
class ProductPhotolibraryViewCell: UICollectionViewCell {
    ...
    let lableIndexHighligh: UILabel = {
          let label = UILabel()
          label.text = "1"
    ...
    func SetupTableViewCell(){
        ...
        CellImage.addSubview(lableIndexHighligh)
        ...
        viewProductNamelable.anchor(ProductNamelable.topAnchor, left: CellImage.leftAnchor, bottom: CellImage.bottomAnchor, right: CellImage.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 0)
        ...
        lableIndexHighligh.anchor(CellImage.topAnchor, left: nil, bottom: nil, right: CellImage.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 25, heightConstant: 25)
                
        deleteProductButton.isHidden = !isEditing
        lableIndexHighligh.isHidden = true
        CellImage.layer.borderColor = UIColor.BlueLight.cgColor
    }
