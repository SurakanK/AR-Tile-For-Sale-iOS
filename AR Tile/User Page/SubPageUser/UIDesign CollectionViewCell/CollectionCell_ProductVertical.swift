//
//  CollectionCell_ProductVertical.swift
//  AR Tile
//
...
class CollecitonCell_ProductVertical : UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        Im_Product.anchor(topAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: frame.width, heightConstant: frame.width)
        
        // Label Name
        view.addSubview(Lb_NamePro)
        Lb_NamePro.anchor(Im_Product.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, topConstant: 5 * ratio, leftConstant: 5 * ratio, bottomConstant: 0, rightConstant: 5 * ratio, widthConstant: 0, heightConstant: 0)
        ...
        Lb_NumSoldPro.anchor(nil, left: nil, bottom: bottomAnchor, right: Lb_NamePro.rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 5 * ratio, rightConstant: 0, widthConstant: 0, heightConstant: 0)
