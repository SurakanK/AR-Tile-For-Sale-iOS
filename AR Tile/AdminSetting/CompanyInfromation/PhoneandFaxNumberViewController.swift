//
//  PhoneandFaxNumberViewController.swift
//  AR Tile
//
...
class PhoneandFaxNumberViewController: UIViewController, UITableViewDelegate, UITableViewDataSource , UIImagePickerControllerDelegate , UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Phone and Fax Number"
        ...
        if CompanyInfromationController.self.CompanyData.count > 0{
            ...
            TextPhone = data[0]["CompanyTel"]!
            TextFax = data[0]["CompanyFax"]!
        }else{
            TextPhone = ""
            TextFax = ""
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.textField.text = TextPhone
        case 1:
            placeholder = "company fax number"
            cell.textField.text = TextFax
        default:break
        }
        ...
        cell.addSubview(cell.textClearButton)
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if section == 0{
            header.HeaderTextLabel.text = "Phone Number"

        }else{
            header.HeaderTextLabel.text = "Fax Number"
        }
    ...
    @objc func TextFieldChange(sender: AnyObject){
        ...
        switch indexPath?.section {
        case 0:
            TextPhone = textfieldChange(IndexPhath: indexPath!)
        case 1:
            TextFax = textfieldChange(IndexPhath: indexPath!)
        default:break
        }
    }
    ...
    @objc func TextFieldDidEnd(sender: AnyObject){
        ...
        switch indexPath?.section {
        case 0:
            TextPhone = textfieldDidEnd(IndexPhath: indexPath!)
        case 1:
            TextFax = textfieldDidEnd(IndexPhath: indexPath!)
        default:break
        }
    }
    ...
    @objc func TextFieldCheck(sender: AnyObject){
        ...
        if IndexText! > 0 {
            if TextPhone != "" && TextFax != "" && isValidPhone(phone: TextPhone) && isValidPhone(phone: TextFax){
   ...
   func textfieldDidBegin(IndexPhath: IndexPath){
    ...
    @objc func ConfirmButton(){
        ...
        editCompanySetting(token: tokenID!, name: data["CompanyName"]!, tel: TextPhone, fax: TextFax, address: data["CompanyAddress"]!, email: data["CompanyEmail"]!, website: data["CompanyWebsite"]!, Image: data["CompanyImage"]!)
    }
    
    func isValidPhone(phone: String) -> Bool {
            let phoneRegex = "^[0-9+]{0,1}+[0-9]{8,16}$"
