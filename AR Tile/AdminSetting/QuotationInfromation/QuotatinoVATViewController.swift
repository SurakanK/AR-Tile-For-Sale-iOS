//
//  QuotatinoVATViewController.swift
//  AR Tile
//
...
class QuotatinoVATViewController:  UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Product VA"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textField.text = String(Data["vat"] as! Int)
        ...
        cell.textField.placeholder = "VAT"
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        header.HeaderTextLabel.text = "Product VAT"
        return header
    }
    ...
    @objc func ConfirmButton(){
        ...
        TextVAT = cell.textField.text!
        
        let data = QuotationInfromationController.QuotationData[0]
        editQuotationSetting(token: tokenID!, ShowLogo: String(data["ShowLogo"] as! Int), RemarkHeader: data["RemarkHeader"] as! String, TaxID: data["TaxID"] as! String, vat: TextVAT, RemarkBottom: data["RemarkBottom"] as! String, Approveby: data["Approveby"] as! String, ApprovebySign: data["ApprovebySign"] as! String)
